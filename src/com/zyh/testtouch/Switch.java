...
/**
 * Created by keith on 14-9-29. User keith Date 14-9-29 Time ÏÂÎç10:08
 */
public class Switch extends CompoundButton {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        heightMeasureSpec = MeasureSpec
                .makeMeasureSpec(measureHeight(heightMeasureSpec), MeasureSpec.EXACTLY);
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (isChecked()) {
            ...
            canvas.drawLine((getWidth() - mSwitchWidth) / 2 + mSwitchRippleMaxRadius + mSwitchThumbRadius,
                    getHeight() / 2, getWidth() - mSwitchRippleMaxRadius - mSwitchThumbRadius,
            ...
            switch (mState) {
                case StateTouchDown:
                    ...
                    canvas.drawCircle(getWidth() - (getWidth() - mSwitchWidth) / 2 - mSwitchRippleMaxRadius,
                            getHeight() / 2, mSwitchRippleMaxRadius, ripplePaint);
                    break;
                case StateTouchUp:
                    break;
                case StateNormal:
            ...
            canvas.drawCircle(getWidth() - (getWidth() - mSwitchWidth) / 2 - mSwitchRippleMaxRadius,
                    getHeight() / 2, mSwitchThumbRadius, thumbFillPaint);
        } else {
            trackPaint.setStrokeWidth(mTrackWidth);
            ...
            canvas.drawCircle((getWidth() - mSwitchWidth) / 2 + mSwitchRippleMaxRadius, getHeight() / 2,
