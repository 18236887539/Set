 ...
 * onDraw function of the View to perform animation. You should in your View
 * onMeasure() call to this class.
 */
public class TouchEffectAnimator {
    ...
    private void initTouch() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
            mRectPath.addRoundRect(new RectF(0, 0, mView.getWidth(), mView.getHeight()), mRadii,
                    Path.Direction.CW);
        else
