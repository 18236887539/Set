...
public class OverScrollView2 extends FrameLayout implements OnTouchListener {
    ...
    static final int ANIMATED_SCROLL_GAP = 150;

    static final float MAX_SCROLL_FACTOR = 0.9f;
    static final float OVERSHOOT_TENSION = 0.9f;
    ...
    public boolean isOverScrolled() {
        return (getScrollY() < child.getPaddingTop() || getScrollY() > child.getBottom()
                - child.getPaddingBottom() - getHeight());
    }
        ...
        if (isInFlingMode) {
            ...
            if (topOfVisibleView < paddingTop || topOfVisibleView > contentBottom - displayHeight) {
                if (topOfVisibleView < paddingTop) {
                    ...
                    mScroller.startScroll(0, topOfVisibleView, 0, contentBottom - displayHeight
