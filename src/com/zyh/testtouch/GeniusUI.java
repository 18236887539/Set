...
public class GeniusUI {
    ...
    public static Typeface getFont(Context context, GeniusAttributes attributes) {
        String fontPath = "fonts/" + attributes.getFontFamily() + "_" + attributes.getFontWeight() + "."
    ...
    /**
     * Sets the default theme of the application. The views which doesn't have
     * any theme attribute will have this defined default theme.
     * <p/>
     * IMPORTANT: This method should be called before setContentView method of
     * the activity.
     *
     * @param theme
     *            Theme Id
