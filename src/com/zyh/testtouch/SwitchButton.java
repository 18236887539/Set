...
import com.zyh.testtouch.AnimationController.OnAnimateListener;
...
public class SwitchButton extends CompoundButton {
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mConf.setThumbMarginInPixel(
                ta.getDimensionPixelSize(R.styleable.SwitchButton_thumb_marginTop, mConf.getThumbMarginTop()),
    ...
    private Drawable fetchThumbDrawable(TypedArray ta) {
        ...
        int pressedColor = ta.getColor(R.styleable.SwitchButton_thumbPressedColor,
